...
$sqlselect = mysqli_query(
    $con,
    " SELECT accounts.*, contacts.*, biodata.email, biodata.foto_non_formal
      FROM accounts 
                                ...
                                <div class="card-body">
                                    ...
                                    <span>
                                        <a class="float-right rounded-lg font-button text-right mt-4"
                                            href="<?php echo htmlspecialchars("edit_kontak.php?email=$_SESSION[email]"); ?>"
                                            role="button">Edit Kontak</a>
                                    </span>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    <p class="card-description">
                                        Silakan lengkapi form kontak dibawah ini
                                    </p>
                                    <form class="forms-sample">
                                        <div class="form-group">
                                            <label for="exampleInputName1">Id Line</label>
                                            <input type="text" class="form-control text-muted" id="exampleInputName1"
                                                value="<?= $id_line; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Instagram</label>
                                            <input type="text" class="form-control text-muted" id="exampleInputEmail3"
                                                value="<?= $instagram; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">Nomor Telepon Pribadi</label>
                                            <input type="text" class="form-control text-muted" value="<?= $no_telp; ?>"
                                                disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">Nomor Telepon Orang Tua/Wali</label>
                                            <input type="text" class="form-control text-muted"
                                                value="<?= $no_telp_ortu; ?>" disabled>
                                        </div>
                                    </form>
                                </div>
                            </div>
