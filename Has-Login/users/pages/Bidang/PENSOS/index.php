                    ...
                    <li class="nav-item active">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="./">FIKTI CAREER 2023</a></li>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h2 class="font-weight-bold">FIKTI Career 2023</h2>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card" style="border-radius: 10px !important;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align: justify;">Merupakan program kerja yang membantu menyalurkan wawasan dan pengetahuan kepada Mahasiswa/i FIKTI UG dan umum mengenai hal-hal penting apa saja yang harus dipersiapkan dalam menghadapi dunia kerja.</p>
