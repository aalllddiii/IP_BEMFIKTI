      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="content-wrapper">
            ...
            <!-- Nav Pills for create menu and detail menu start-->
            <div class="template-demo">
              <div class="btn-group" role="group" aria-label="Basic example">
                <ul class="nav nav-pills nav-fill">
                  <li class="nav-item mr-3 mb-3">
                    <a class="nav-link active btn btn-danger py-2" href="#bidang" data-toggle="tab"><i class="mdi mdi-format-list-numbered icon-sm"></i> Bidang</a>
                  </li>
                  <li class="nav-item mr-3 mb-3">
                    <a class="nav-link btn btn-danger py-2" href="#biro_depart" data-toggle="tab"><i class="mdi mdi-format-list-numbered icon-sm"></i> Biro Department</a>
                  </li>
                </ul>
              </div>
            </div>
            <!--Nav Pills for create menu and detail menu end-->

            <!--Content Nav Pills start-->
            <div class="tab-content">

              <!-- content for nav link #daftar_payment_method start-->
              ...
              <!-- content for nav link #daftar_payment_method end -->

              <!-- content for nav link #tambah_payment_method start -->
  		      	<div class="tab-pane fade" id="biro_depart">
              ...
              <!-- content for nav link #tambah_payment_method end -->
