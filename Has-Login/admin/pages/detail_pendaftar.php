                    ...
                    <div class="berkas mx-5 mb-5 ">
                      <?php if($data['krs'] != NULL) :?>
                        ...
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../requirement/krs/".$data['krs']; ?>" ></iframe>
                        </div>
                      <?php
                        endif;
                      ...
                      ?>
                        ...
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../requirement/rangkuman_nilai/".$data['rangkuman_nilai']; ?>" ></iframe>
                        </div>
                      <?php
                        endif;
                      ...
                      ?>
                        ...
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../requirement/surat_pernyataan/".$data['surat_pernyataan']; ?>" ></iframe>
                        </div>
                      <?php
                        endif;
                      ...
                      ?>
                        ...
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../requirement/portofolio/".$data['portofolio']; ?>" ></iframe>
                        </div>
                      <?php endif; ?>
