                    ...
                    <li class="nav-item active">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="./">FIKTI SPACE 2.0</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../PENSOS/">FIKTI CAREER 2023</a></li>
                                <li class="nav-item"> <a class="nav-link" href="../POLKESMA/">HEROES IX</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h2 class="font-weight-bold">FIKTI SPACE 2.0</h2>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card" style="border-radius: 10px !important;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align: justify;">Merupakan program kerja dari Departemen Olahraga dan Seni Budaya BEM FIKTI UG yang berisikan sebuah rangkaian kompetisi olahraga dan kesenian.</p>
                                    <p class="card-description" style="text-align: justify;">
                                        <b>
                                        Divisi yang tersedia : Acara, Media, Danus, Sponsorship, Humas, Operasional, Konsumsi, Keamanan, Kesehatan
                                        </b>
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 mb-3 mt-3 mb-lg-0 stretch-card ">
                                    <div class="card ">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">
                                                <!-- <img src="../../../../../assets/images_bidang/Bismit.png" class="img-lg"> -->
                                                <span class="fs-18">Divisi Operasional</span>
                                            </h4>
                                            <p class="fs-17 mb-2" style="text-align: justify;">Divisi yang bertanggung jawab untuk mengelola dan mengatur  seluruh aspek teknis selama acara berlangsung dan segala sesuatu yang berkaitan dengan pelaksanaan acara yang akan diselenggarakan oleh panitia tersebut.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 mt-3 mb-lg-0 stretch-card ">
                                    <div class="card ">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">
                                                <!-- <img src="../../../../../assets/images_bidang/Bismit.png" class="img-lg"> -->
                                                <span class="fs-18">Divisi Konsumsi</span>
                                            </h4>
                                            <p class="fs-17 mb-2" style="text-align: justify;">Divisi yang bertanggung jawab untuk mengelola dan mengatur segala sesuatu yang berkaitan dengan konsumsi, seperti makanan dan minuman, yang dibutuhkan dalam acara serta mengkoordinasikan dengan vendor atau pihak lain yang terkait dengan pembuatan dan pengiriman makanan dan minuman.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 mt-3 mb-lg-0 stretch-card ">
                                    <div class="card ">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">
                                                <!-- <img src="../../../../../assets/images_bidang/Bismit.png" class="img-lg"> -->
                                                <span class="fs-18">Divisi Keamanan</span>
                                            </h4>
                                            <p class="fs-17 mb-2" style="text-align: justify;">Divisi yang bertanggung jawab untuk mengelola dan mengatur segala sesuatu yang berkaitan dengan keamanan dalam acara serta  mengkoordinasikan dengan pihak-pihak terkait seperti instansi keamanan setempat.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 mt-3 mb-lg-0 stretch-card ">
                                    <div class="card ">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">
                                                <!-- <img src="../../../../../assets/images_bidang/Bismit.png" class="img-lg"> -->
                                                <span class="fs-18">Divisi Kesehatan</span>
                                            </h4>
                                            <p class="fs-17 mb-2" style="text-align: justify;">Divisi ini bertanggung jawab untuk menyusun rencana kesehatan seperti pencegahan dan penanggulangan masalah kesehatan,  pengaturan layanan medis darurat, mengkoordinasikan dengan pihak-pihak terkait seperti instansi kesehatan setempat dan mengatur seluruh aspek kesehatan selama acara berlangsung.
</p>
                                        </div>
                                    </div>
                                </div>
