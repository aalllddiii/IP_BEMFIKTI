                    ...
                    <li class="nav-item active">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="./">TECHNOFAIR 10.0</a></li>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h2 class="font-weight-bold">TechnoFair 10.0</h2>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card" style="border-radius: 10px !important;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align: justify;">Merupakan program kerja unggulan Departemen Akademik sekaligus event IT
terbesar di FIKTI UG yang dilaksanakan setiap tahun. Event ini berisi rangkaian acara
berupa seminar, workshop, dan kompetisi.</p>
