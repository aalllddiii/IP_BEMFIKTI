...
$sqlselect = mysqli_query($con, " SELECT accounts.*, biodata.email, biodata.foto_non_formal, data_studi.*
                                      FROM accounts 
...
if ($stats_daftar >= 1) {
    echo "<script>alert('Maaf tidak bisa edit data studi, sudah deadline'); 
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h2 class="font-weight-bold">Data Studi</h2>
                                </div>
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Form Edit Data Studi</h4>
                                    <form class="forms-sample" action="<?= htmlspecialchars("../../../config/data_studi.php"); ?>" method="POST">
                                        <input name="email" type="text" value="<?php echo $_SESSION['email']; ?>" hidden>
                                        <div class="form-group">
                                            <label for="exampleInputName1">NPM</label>
                                            <input type="text" name="npm" class="form-control text-muted" id="exampleInputName1" value="<?= $npm; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Kelas</label>
                                            <input type="text" name="kelas" class="form-control text-muted" id="exampleInputEmail3" value="<?= $kelas; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">Jurusan</label>
                                            <div class="form-group">
                                                <select name="jurusan" class="form-control form-control-lg" id="exampleFormControlSelect1" value="<?= $jurusan; ?>">
                                                    <option value="Sistem Informasi" <?php echo (($jurusan == "Sistem Informasi") ? "selected" : "") ?>>Sistem Informasi</option>
                                                    <option value="Sistem Komputer" <?php echo (($jurusan == "Sistem Komputer") ? "selected" : "") ?>>Sistem Komputer</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">Domisili Kampus</label>
                                            <div class="form-group">
                                                <select name="domisili" class="form-control form-control-lg" id="exampleFormControlSelect1" value="<?= $domisili; ?>">
                                                    <option value="Cengkareng" <?php echo (($domisili == "Cengkareng") ? "selected" : "") ?>>Cengkareng</option>
                                                    <option value="Depok" <?php echo (($domisili == "Depok") ? "selected" : "") ?>>Depok</option>
                                                    <option value="Kalimalang" <?php echo (($domisili == "Kalimalang") ? "selected" : "") ?>>Kalimalang</option>
                                                    <option value="Karawaci" <?php echo (($domisili == "Karawaci") ? "selected" : "") ?>>Karawaci</option>
                                                    <option value="Salemba" <?php echo (($domisili == "Salemba") ? "selected" : "") ?>>Salemba</option>
                                                    <option value="Simatupang" <?php echo (($domisili == "Simatupang") ? "selected" : "") ?>>Simatupang</option>
                                                </select>
                                            </div>
                                        </div>
                                        <button type="submit" name="update_data_studi" class="btn btn-primary mr-2 col-lg-3 col-12" style="border-radius: 10px;">Update</button>
                                    </form>
                                </div>
                            </div>
                        </div>
