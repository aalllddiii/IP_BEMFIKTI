                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-primary mb-4" role="button" style="border-radius: 6px;"
                                        href="<?php echo htmlspecialchars("edit_data.php"); ?>">Edit Data</a>
                                    <?php } ?>
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="" class="form-label">Pilihan 1</label>
                                            <input type="text" class="form-control text-muted"
                                                value="<?= $pilihan_satu; ?>" disabled>
                                        </div>
                                       
                                        <div class="col-6">
                                            <label for="" class="form-label">Pilihan 2</label>
                                            <input type="text" class="form-control text-muted"
                                                value="<?= $pilihan_dua; ?>" disabled>
                                        </div>
                                       
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-6">
                                            <label for="" class="form-label">Tuliskan 2 divisi yang diinginkan berdasarkan Pilihan 1 dan sertakan alasannya</label>
                                            <textarea class="form-control text-muted" rows="3"
                                                disabled><?= $alasan_pilih_satu; ?></textarea>
                                        </div>
                                        <div class="col-6">
                                            <label for="" class="form-label">Tuliskan 2 divisi yang diinginkan berdasarkan Pilihan 2 dan sertakan alasannya</label>
                                            <textarea class="form-control text-muted" rows="3"
                                                disabled><?= $alasan_pilih_dua; ?></textarea>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <label for="" class="form-label">Alasan mengikuti OPREC VOLUNTEER BEM FIKTI UG</label>
                                            <textarea class="form-control text-muted" rows="3"
                                                disabled><?= $alasan_ikut; ?></textarea>
                                        </div>
                                        <div class="col-12 mt-3">
                                            <label for="" class="form-label">Harapan yang ingin dicapai setelah selesai
                                                mengikuti OPREC VOLUNTEER BEM FIKTI UG</label>
                                            <textarea class="form-control text-muted" rows="3"
                                                disabled><?= $harapan; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
