              ...
              <table id="example" class="table table-bordered table-hover dt-responsive nowrap text-center" style="width:100%; background-color:#fff;">
                ...
                ?>
                  <tr>
                    ...
                    ?>
                      <a href="<?php echo "../../requirement/foto_formal/".$file['foto_formal']; ?>" download>
                        <img src="<?php echo "../../requirement/foto_formal/".$file['foto_formal']; ?>" style="width: 100px; height: 100px;">
                      </a>
                    <?php } ?>
                    </td>
                    <td>
                    ...
                    ?>
                      <a href="<?php echo "../../requirement/foto_bebas/".$file['foto_non_formal']; ?>" download>
                        <img src="<?php echo "../../requirement/foto_bebas/".$file['foto_non_formal']; ?>" style="width: 100px; height: 100px;">
                      </a>
                    <?php } ?>
                    </td>
                    <td>
                      <a href="<?php echo "../../requirement/krs/".$file['krs']; ?>" download>
                        <?= $file['krs']; ?>
											</a>
                    </td>
                    <td>
                      <a href="<?php echo "../../requirement/rangkuman_nilai".$file['rangkuman_nilai']; ?>" download>
                        <?= $file['rangkuman_nilai']; ?>
											</a>
                    </td>
                    <td>
                      <a href="<?php echo "../../requirement/portofolio/".$file['portofolio']; ?>" download>
                        <?= $file['portofolio']; ?>
					            </a>
                    </td>
                  </tr>
