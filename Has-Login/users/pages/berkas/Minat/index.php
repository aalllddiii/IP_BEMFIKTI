...
$sqlselect = mysqli_query(
    $con,
    " SELECT accounts.*, minat_kegiatan.*, biodata.email, biodata.foto_non_formal, data_studi.npm, data_studi.email
      FROM accounts 
      ...
      JOIN minat_kegiatan ON accounts.email = minat_kegiatan.email AND minat_kegiatan.email = '$_SESSION[email]' 
...
while ($datas = mysqli_fetch_array($sqlselect)) {
    ...
    $npm = $datas['npm'];
    $akademik   = explode(',', $datas['akademik']);
    $kesenian   = explode(',', $datas['kesenian']);
    $olahraga   = explode(',', $datas['olahraga']);
    $media_kreatif   = explode(',', $datas['media_kreatif']);
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <form action="<?= htmlspecialchars("../../../config/minat.php"); ?>" method="POST">
                        <div class="row">
                            <div class="col-md-12 grid-margin">
                                <div class="row">
                                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                        <h2 class="font-weight-bold">Peminatan Kegiatan</h2>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card mt-3">
                                    <div class="card-body">
                                        <h1 class="card-title">Akademik</h1>
                                        <div class="row">
                                            <?php require_once("./array_akademik.php"); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="card mt-3">
                                    <div class="card-body">
                                        <h1 class="card-title">Olahraga</h1>
                                        <div class="row">
                                            <?php require_once("./array_olahraga.php"); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="card mt-3">
                                    <div class="card-body">
                                        <h1 class="card-title">Kesenian</h1>
                                        <div class="row">
                                            <?php require_once("./array_kesenian.php"); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="card mt-3">
                                    <div class="card-body">
                                        <h1 class="card-title">Media Kreatif</h1>
                                        <div class="row">
                                            <?php require_once("./array_medkraf.php"); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <button type="submit" name="update_minat"
