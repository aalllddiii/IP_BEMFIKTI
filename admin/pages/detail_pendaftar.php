...
<html lang="en">
  <head>
    <title>Data Personal IP BEM FIKTI 2022</title>
                ...
                <ol class="breadcrumb">
                  <li class="breadcrumb-item">
                    <a href="data.php?email=<?=$email;?>" target="_BLANK">
                      <button class="btn btn-success">Download Formulir <i class="mdi mdi-file-pdf"></i></button>
                    </a>
                  </li>
                </ol>
              </nav>
              ...
              <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <table class="table-custom mb-3">
                        <tr>
                          ...
                          <td rowspan="5"><img src="<?php echo "../../Has-Login/requirement/foto_formal/".$data['foto_formal']; ?>" alt="" width="150px"></td>
                        </tr>
                        <tr>
                          <td>
                      ...
                      <table class="table-custom mb-3">
                        <tr>
                          <td class="text-muted">VII. Alasan mengikuti OPREC VOLUNTEER BEM FIKTI UG</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td class="text-muted">IX. Harapan Dari Mengikuti IP BEM FIKTI</td>
                        </tr>
                        <tr>
                          <td>
                            <p class="text-justify">
                    ...
                    <div class="berkas mx-5 mb-5 ">
                      <?php if($data['krs'] != NULL) :?>
                        <h3 class="my-3">KRS</h3>
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../Has-Login/requirement/krs/".$data['krs']; ?>" ></iframe>
                        </div>
                      <?php
                        endif;
                        if($data['rangkuman_nilai'] != NULL) :
                      ?>
                        <h3 class="my-3">Rangkuman Nilai</h3>
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../Has-Login/requirement/rangkuman_nilai/".$data['rangkuman_nilai']; ?>" ></iframe>
                        </div>
                      <?php
                        endif;
                        if($data['surat_pernyataan'] != NULL) :
                      ?>
                        <h3 class="my-3">Surat Pernyataan</h3>
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../Has-Login/requirement/surat_pernyataan/".$data['surat_pernyataan']; ?>" ></iframe>
                        </div>
                      <?php
                        endif;
                        if($data['portofolio'] != NULL) :
                      ?>
                        <h3 class="my-3">Portofolio</h3>
                        <div class="embed-responsive embed-responsive-4by3">
                          <iframe class="embed-responsive-item" src="<?php echo "../../Has-Login/requirement/portofolio/".$data['portofolio']; ?>" ></iframe>
                        </div>
                      <?php endif; ?>
