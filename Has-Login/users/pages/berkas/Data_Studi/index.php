                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        <span>
                                            <a class="float-right rounded-lg font-button text-right mt-4" href="<?php echo htmlspecialchars("edit_data_studi.php?email=$_SESSION[email]"); ?>" role="button">Edit Data Studi</a>
                                        </span>
                                    <?php
                                    }
                                    ?>
                                    <h4 class="card-title">Form Data Studi</h4>
                                    <p class="card-description">
                                        Silakan lengkapi form data studi dibawah ini
                                    </p>
                                    <form class="forms-sample">
                                        <div class="form-group">
                                            <label for="exampleInputName1">NPM</label>
                                            <input type="text" class="form-control text-muted" id="exampleInputName1" value="<?= $npm; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Kelas</label>
                                            <input type="text" class="form-control text-muted" id="exampleInputEmail3" value="<?= $kelas; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Jurusan</label>
                                            <input type="text" class="form-control text-muted" id="exampleInputEmail3" value="<?= $jurusan; ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword4">Domisili Kampus</label>
                                            <input type="text" class="form-control text-muted" value="<?= $domisili; ?>" disabled>
                                        </div>
                                    </form>
                                </div>
                            </div>
